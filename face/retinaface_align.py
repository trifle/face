"""
Alignment code from insightface https://github.com/deepinsight/insightface
...
def estimate_norm(lmk, image_size=150):
...
def norm_crop(img, landmark, image_size=150):
